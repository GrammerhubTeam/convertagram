...
units['bit'] = {unit:'bit', base: 'b', name: 'bit', type: 'storage', factor: 0.125, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
...
units['kib'] = {unit:'kib', base: 'b', name: 'kibibyte', type: 'storage', factor: 2**10, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
units['mib'] = {unit:'mib', base: 'b', name: 'mebibyte', type: 'storage', factor: 2**20, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
units['gib'] = {unit:'gib', base: 'b', name: 'gibibyte', type: 'storage', factor: 2**30, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
units['tib'] = {unit:'tib', base: 'b', name: 'tebibyte', type: 'storage', factor: 2**40, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
//units['pib'] = {unit:'pib', base: 'b', name: 'pebibyte', type: 'storage', factor: 2**50, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
//units['eib'] = {unit:'eib', base: 'b', name: 'exibyte', type: 'storage', factor: 2**60, dataSource: "https://physics.nist.gov/cuu/Units/binary.html" };
//units['zib'] = {unit:'zib', base: 'b', name: 'zebibyte', type: 'storage', factor: 2**70, dataSource: "https://www.geeksforgeeks.org/understanding-file-sizes-bytes-kb-mb-gb-tb-pb-eb-zb-yb/" };
//units['yib'] = {unit:'yib', base: 'b', name: 'yobibyte', type: 'storage', factor: 2**80, dataSource: "https://www.geeksforgeeks.org/understanding-file-sizes-bytes-kb-mb-gb-tb-pb-eb-zb-yb/" };
